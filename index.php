...
<html>
<head>
<title>Sirethorn jaiuifui</title>
<meta charset="UTF-8">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-grey w3-text-white w3-card-4">
        ...
        <div class="w3-container">
          <p><i class="fa fa-person fa-fw w3-margin-right w3-large w3-text-aqua"></i>Sirethorn Jaiuifui</p>
          ...
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-aqua"></i>sirethorn.jai@msu.ac.th</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-aqua"></i>0839316709</p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-grey w3-margin-bottom">
        <h2 class="w3-text-white w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-aqua"></i>Work Experience (Nothing)</h2>    
      </div>
